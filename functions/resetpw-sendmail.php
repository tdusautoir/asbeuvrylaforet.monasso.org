...
if (isset($_POST["submit"])) {
    if (!empty($_POST["email"]) && isset($_POST["email"])) {
        if (filter_var($_POST["email"], FILTER_VALIDATE_EMAIL)) {
            ...
            if ($utilisateur_admin) {  //utilsateur_admin = true donc utilisateur trouvé en tant que admin
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align='center'>
                                                                                                    <table border='0' cellspacing='0' cellpadding='0'>
                                                                                                        <tr>
                                                                                                            <td class='text-button' style='color:#ffffff; background:#309C34; border-radius:5px; font-family:Yantramanav, Arial, sans-serif; font-size:14px; line-height:18px; text-align:center; font-weight:500; padding:12px 25px;'><a href='https://www.dev-asbeuvrylaforet.monasso.org/resetpw.php?token=$token' target='_blank' class='link-white' style='color:#ffffff; text-decoration:none;'><CENTER><span class='link-white' style='color:#ffffff; text-decoration:none;'>Réinitialiser</span></CENTER></a></td>
                                                                                                        </tr>
                                                                                                    </table>
                                                                                                    
                                                                                                    <tr>
                                                                                                        <td class='text' style='padding-bottom: 25px;padding-top: 25px; color:#666666; font-family:Arial, sans-serif; font-size:16px; line-height:30px;text-align:center; min-width:auto !important;'>Si vous avez un problème pour visualiser ce mail, n'hésitez pas à cliquez <a href='https://www.dev-asbeuvrylaforet.monasso.org/resetpw.php?token=$token'><strong>ici</strong></a> !</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td align='right'>
            ...
            } else { //Aucun admin trouvé dans la base de données
                ...
                if ($utilisateur_educ) {
                    ...
                    $insert_token = $db->prepare("UPDATE educ SET date_cr_token = NOW(), pw_recup_token = ? WHERE mail = ? ");
